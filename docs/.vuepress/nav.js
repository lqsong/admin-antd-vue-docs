module.exports = [
    ...
    },
    {
		...
		items: [            
            ...
            {text: 'electron-admin-antd-vue', link: '/guide/senior/electron'},
        ...
        items: [
            {
                text: '其他版本',
                items: [
                    {text: 'vite.ts', link: 'http://admin-antd-vue.liqingsong.cc/vitets/'},
                ] 
            }            
        ]
    },
    ...
    },
    {
        text: 'GitHub',
		items: [
            {text: 'Github', link: 'https://github.com/lqsong/admin-antd-vue'},
            {text: 'Gitee', link: 'https://gitee.com/lqsong/admin-antd-vue'},
        ]
    }
]